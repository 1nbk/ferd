<template>
  <footer class="bg-bg-dark text-white/80 mt-12 sm:mt-16 lg:mt-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 sm:gap-12">
        <div class="lg:col-span-2">
          <div class="flex items-center space-x-2 mb-6">
            <span class="text-3xl font-serif font-bold text-white">Ferd</span>
          </div>
          <p class="text-sm text-white/60 leading-relaxed mb-8 max-w-xs">
            Discover homes tailored to your lifestyle and needs. Redefining excellence in real estate.
          </p>
          <div class="flex space-x-6">
            <a href="#" class="text-white/60 hover:text-accent transition-colors duration-300">
      ...
      <div class="border-t border-white/10 mt-12 pt-8 text-center text-xs sm:text-sm text-white/40">
